...
def update_api_creds() -> str:
    return "UPDATE users SET api_key = :api_key, api_secret = :api_secret, api_passphrase = :api_passphrase WHERE tg_id = :tg_id"

def get_api_creds() -> str:
    return "SELECT api_key, api_secret, api_passphrase FROM users WHERE tg_id = :tg_id"